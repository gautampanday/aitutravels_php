 <div class="signin_wrapper">
    <div class="row">
      <div class="right_block">
        <div class="row">
          <form class="col-md-12 col-sm-12 col-xs-12" name="form" ng-submit="login()" autocomplete="off">
